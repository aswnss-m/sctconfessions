...
function Main() {
  return (
    <main>
        ...
        <Link to={'/Confess'}><button className="button-19" role="button">Confess</button></Link>
        <Link to={'/Wall'}><button className="button-19" role="button">Confession Wall</button></Link>
        </div>
    </main>
  );
}
